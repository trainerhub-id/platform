...
import { createDefaultMasterJson, createDocumentRecord, isDocumentOwner } from "./document.repository";
...
describe("document repository helpers", () => {
  ...
  it("creates a document record shape", () => {
    const record = createDocumentRecord({ ownerUserId: "user_1", flow: "master", title: "Dokumen Master" });
