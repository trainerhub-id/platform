...
import { type ExtractionResult, extractionResultSchema } from '../interview/extraction.schemas'
...
const legacyPatchPathMap: Record<
  'master' | 'trainer',
  Record<string, { phaseKey: string; fieldKey: string }>
> = {
  master: {
...
export function normalizeExtractionObject(
  value: unknown,
  defaultFlow: 'master' | 'trainer' = 'master',
): ExtractionResult {
