                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-xl overflow-hidden shrink-0 shadow-sm border border-gray-100">
                          ...
                          <div
                            className={`w-full h-full bg-gradient-to-br from-[#F8F4ED] to-[#EDE5D8] flex items-center justify-center ${course.imageUrl ? 'hidden' : ''}`}
                          >
                            <Icon
                        ...
                        <div>
                          ...
                          <p className="text-xs text-bodytext mt-1 line-clamp-1 max-w-[300px]">
                            {course.description}
                          </p>
                        </div>
                      </div>
