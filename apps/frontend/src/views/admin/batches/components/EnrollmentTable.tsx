            ...
            {enrollments.length > 0 ? (
              ...
              <tr>
                <td colSpan={6} className="px-4 py-16 text-center">
                  <Icon icon="solar:users-group-rounded-linear" height={48} className="mx-auto text-bodytext/50" />
                  <p className="mt-2 font-medium text-dark">Belum ada member di batch ini</p>
                  <p className="mt-1 text-sm text-bodytext">Member akan muncul setelah registrasi atau assign manual.</p>
                </td>
              </tr>
            )}
          </tbody>
