    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-bodytext text-sm">
          Berikut adalah ringkasan aktivitas training center Anda hari ini.
        </p>
      </div>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => (window.location.href = '/admin/daftar-peserta')}
                >
                        ...
                        <img
                          ...
                          onError={(e) => {
                            ;(e.target as HTMLImageElement).src =
                              `https://ui-avatars.com/api/?name=${participant.name}&background=random`
                          }}
                        />
                      </div>
                      <div>
