            ...
            {templates.length === 0 ? (
                <Card>
                    <CardContent className="py-12 text-center">
                        <Icon icon="solar:document-text-line-duotone" className="mx-auto mb-4 text-bodytext" height={64} />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="space-y-1 max-h-40 overflow-y-auto">
                                        ...
                                        {template.items.length > 5 && (
                                            <p className="text-xs text-bodytext">+{template.items.length - 5} more items</p>
                                        )}
                                    </div>
                                </div>
                            </CardContent>
