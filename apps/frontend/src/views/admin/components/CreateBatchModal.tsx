    ...
    if (open) {
      ...
      if (batchToEdit) {
        ...
        setFormData({
          ...
          tanggal: batchToEdit.tanggal
            ? new Date(batchToEdit.tanggal).toISOString()
            : batchToEdit.startDate
              ? new Date(batchToEdit.startDate).toISOString()
              : '',
          tanggalSelesai: batchToEdit.tanggalSelesai
            ? new Date(batchToEdit.tanggalSelesai).toISOString()
            : batchToEdit.endDate
              ? new Date(batchToEdit.endDate).toISOString()
              : '',
          ...
          rundownTemplateId: batchToEdit.rundownTemplateId
            ? batchToEdit.rundownTemplateId.toString()
            : '',
        ...
        if (batchToEdit.tanggal || batchToEdit.startDate) {
          setSelectedRange({
            ...
            to: batchToEdit.tanggalSelesai
              ? new Date(batchToEdit.tanggalSelesai)
              : batchToEdit.endDate
                ? new Date(batchToEdit.endDate)
                : undefined,
          })
        }
      } else {
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setFormData((prev) => ({ ...prev, rundownTemplateId: val }))
                  }
                >
