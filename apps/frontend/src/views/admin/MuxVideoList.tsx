            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-bodytext">
                        Daftar semua video yang tersimpan di Mux
                    </p>
                </div>
                                        ...
                                        <td className="py-4 px-4">
                                            {asset.playbackId ? (
                                                ...
                                                <div className="w-32 h-18 rounded-lg bg-gray-200 flex items-center justify-center">
                                                    <Icon icon="solar:videocamera-slash-linear" className="text-gray-400" height={24} />
                                                </div>
                                            )}
                                        </td>
                                        <td className="py-4 px-4">
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-xs text-bodytext">Duration: {formatDuration(asset.duration)}</p>
                                                <p className="text-xs text-bodytext">Resolution: {asset.maxStoredResolution}</p>
                                                <p className="text-xs text-bodytext">Created: {formatDate(asset.createdAt)}</p>
                                            </div>
                                        </td>
                                        <td className="py-4 px-4">
                                            {asset.playbackId ? (
                                                <div className="space-y-2">
                                                    ...
                                                    <Badge className={`text-xs ${asset.playbackPolicy === 'signed' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'}`}>
