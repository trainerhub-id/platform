...
const EditKelas = () => {
    ...
    const handleSaveChapter = async (data: { title: string; description?: string; thumbnailUrl?: string }) => {
        setLoading(true);
        try {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-xl font-bold text-dark">{isEditMode ? 'Edit Kelas' : 'Buat Kelas Baru'}</h2>
                </div>
            </div>
            ...
            <CardBox>
                <form onSubmit={handleSubmit} className="space-y-4 p-4">
                    ...
                    <div className="flex justify-end gap-2 pt-4">
                        <Button type="button" variant="outline" onClick={() => navigate('/admin/manage-kelas')} disabled={loading}>
                            Batal
                        </Button>
                                    ...
                                    <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-100">
                                        ...
                                        {chapter.thumbnailUrl ? (
                                            ...
                                            <div className="flex-shrink-0 w-24 h-24 rounded-lg bg-gradient-to-br from-blue-100 to-indigo-200 flex items-center justify-center border-2 border-white shadow-sm">
                                                <span className="text-2xl font-bold text-blue-600">Ch. {chapter.orderIndex}</span>
                                            </div>
                                        )}
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between gap-2 mb-2">
                                                ...
                                                <div className="flex gap-1 flex-shrink-0">
                                                    <Button size="sm" variant="ghost" className="text-blue-600 hover:text-blue-700 hover:bg-white/50" onClick={() => openEditChapterModal(chapter)}>
                                                        <Icon icon="solar:pen-linear" height={18} />
                                                    </Button>
                                                    <Button size="sm" variant="ghost" className="text-red-500 hover:text-red-600 hover:bg-white/50" onClick={() => handleDeleteChapter(chapter.id)}>
                                                ...
                                                >
                                                    <div className="flex items-center gap-3 flex-1">
                                                        <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center">
                                                            <Icon icon="solar:play-circle-bold" className="text-blue-600" height={20} />
                                                        </div>
            ...
            <ChapterModal
                ...
                initialData={isEditingChapter && selectedChapter ? { 
