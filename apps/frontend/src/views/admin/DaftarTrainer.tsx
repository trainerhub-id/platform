    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {trainers.map((trainer) => (
          <CardBox
            key={trainer.id}
            className="border border-gray-200 shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-300"
          >
      ...
      {trainers.length === 0 && (
        <div className="bg-gray-50 border-2 border-dashed border-gray-200 rounded-2xl p-12 text-center">
          ...
          <p className="text-bodytext mb-6">
            Mulai tambahkan trainer untuk dapat di-assign ke batch training.
          </p>
