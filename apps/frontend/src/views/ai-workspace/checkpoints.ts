  ...
  master: [
    {
      ...
      fields: [
        ...
        { phaseKey: 'profile', fieldKey: 'organization_city', label: 'Kota lembaga' },
        { phaseKey: 'profile', fieldKey: 'organization_focus', label: 'Fokus lembaga' },
        { phaseKey: 'profile', fieldKey: 'program_name', label: 'Nama program' },
        { phaseKey: 'profile', fieldKey: 'program_goal', label: 'Tujuan program' },
        { phaseKey: 'profile', fieldKey: 'target_participants', label: 'Target peserta' },
        { phaseKey: 'profile', fieldKey: 'industry_problem', label: 'Masalah industri' },
  ...
  trainer: [
    {
      ...
      fields: [
        ...
        { phaseKey: 'brainstorming', fieldKey: 'expertise', label: 'Keahlian trainer' },
        { phaseKey: 'brainstorming', fieldKey: 'audience', label: 'Audiens' },
        { phaseKey: 'brainstorming', fieldKey: 'outcome', label: 'Hasil belajar' },
        { phaseKey: 'brainstorming', fieldKey: 'institution', label: 'Institusi' },
        {
          phaseKey: 'brainstorming',
          fieldKey: 'activities',
    ...
    },
    {
      ...
      fields: [
        { phaseKey: 'training_details', fieldKey: 'program_name', label: 'Nama program' },
        { phaseKey: 'training_details', fieldKey: 'delivery_method', label: 'Metode pelaksanaan' },
        { phaseKey: 'training_details', fieldKey: 'duration_jp', label: 'Durasi JP' },
      ],
    },
  ],
}
