...
import { DocumentType, DocumentStatus, useDokumen } from '../hooks/useDokumen';
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-white rounded-lg border border-gray-200 hover:border-primary/50 transition-colors gap-4">
            <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    {type.isRequired && (
                        <span className="text-xs font-medium text-red-500">*wajib</span>
                    )}
                </div>
            ...
            <AlertDialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Apakah Anda yakin ingin menghapus dokumen "{type.nama}"? 
