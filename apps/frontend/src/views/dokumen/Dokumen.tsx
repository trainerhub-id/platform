                ...
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-gray-600">
                            Silakan lengkapi seluruh dokumen yang diperlukan untuk administrasi pelatihan dan sertifikasi.
                            Pastikan dokumen yang diunggah valid dan terbaca dengan jelas.
                        </p>
                    </div>
                </div>
