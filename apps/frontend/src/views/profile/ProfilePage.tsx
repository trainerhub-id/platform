...
const ProfilePage = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            toast({
                title: "Gagal",
                description: Array.isArray(errMsg) ? errMsg[0]?.message : (errMsg || 'Gagal menyimpan profil'),
                variant: "destructive",
            });
        } finally {
            setSaving(false);
    ...
    const calculateCompletion = () => {
        ...
        const filledFields = bnspFields.filter(field => formData[field as keyof typeof formData]).length;
    ...
    return (
        <div className="space-y-6">
            ...
            <Card className={`p-5 rounded-2xl border ${isComplete ? 'border-green-200 bg-gradient-to-r from-green-50 to-emerald-50' : 'border-amber-200 bg-gradient-to-r from-amber-50 to-yellow-50'}`}>
                <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4 flex-1">
                        <div className={`h-14 w-14 rounded-xl flex items-center justify-center flex-shrink-0 ${isComplete ? 'bg-green-500' : 'bg-amber-500'}`}>
                            <Icon icon={isComplete ? "solar:verified-check-bold" : "solar:document-add-bold"} height={28} className="text-white" />
                        </div>
                        <div className="flex-1 min-w-0">
                            <h3 className={`font-bold text-base ${isComplete ? 'text-green-800' : 'text-amber-800'}`}>
                    ...
                    <div className="flex items-center gap-3">
                        <div className={`h-14 w-14 rounded-full flex items-center justify-center font-bold text-base ${isComplete ? 'bg-green-500 text-white' : 'bg-amber-500 text-white'}`}>
            ...
            <Card className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <Label htmlFor="nama">Nama Lengkap Sesuai KTP <span className="text-red-500">*</span></Label>
                        <Input
                            id="nama"
                            value={formData.nama}
                    ...
                    <div>
                        <Label htmlFor="noWa">No. WhatsApp Aktif <span className="text-red-500">*</span></Label>
                        <Input
                            id="noWa"
                            value={formData.noWa}
            ...
            <Card className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <Label htmlFor="ttl">Tempat, Tanggal Lahir <span className="text-red-500">*</span></Label>
                        <Input
                            id="ttl"
                            value={formData.ttl}
                    ...
                    <div>
                        <Label htmlFor="jk">Jenis Kelamin <span className="text-red-500">*</span></Label>
                    ...
                    <div>
                        <Label htmlFor="kota">Nama Kota <span className="text-red-500">*</span></Label>
                        <Input
                            id="kota"
                            value={formData.kota}
                    ...
                    <div>
                        <Label htmlFor="provinsi">Nama Provinsi <span className="text-red-500">*</span></Label>
                        <Input
                            id="provinsi"
                    ...
                    <div>
                        <Label htmlFor="pendidikan">Pendidikan Terakhir <span className="text-red-500">*</span></Label>
                        <Input
                            id="pendidikan"
                    ...
                    <div>
                        <Label htmlFor="pekerjaan">Pekerjaan <span className="text-red-500">*</span></Label>
                        <Input
                            id="pekerjaan"
                    ...
                    <div className="md:col-span-2">
                        <Label htmlFor="alamat">Alamat Tempat Tinggal <span className="text-red-500">*</span></Label>
                        <Textarea
                            id="alamat"
