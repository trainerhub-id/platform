...
export const dummyTrainings = [
  {
    ...
    rundown: [
      { time: '08.00', event: 'Registrasi', color: 'var(--color-gold)' },
      { time: '09.00', event: 'Training - Sesi 1', color: '#F3A53F' },
      { time: '09.46', event: 'Break (ISOMA)', color: 'var(--color-primary)' },
  ...
  },
  {
    ...
    dateStart: '01',
    dateEnd: '06 Jan',
    coordinates: [-6.1751, 106.865] as [number, number], // Grand Indonesia, Jakarta
    participants: 12,
    documents: 2,
    participant: {
      name: 'John Doe',
...
export const adminTodos = [
  ...
  },
  {
    ...
    iconBg: 'text-[var(--color-primary)] bg-[#E6F2FF]',
    action: 'Lihat peserta',
    actionColor: 'bg-[var(--color-primary)] hover:bg-[#3470d1]',
    time: '11:45 AM',
  },
  {
    id: 3,
    priority: 'Very High',
    priorityColor: 'text-[var(--color-gold)] bg-[#FEF5E5]',
