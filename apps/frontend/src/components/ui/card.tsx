  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={cn(
          `p-6 text-bodytext bg-white dark:bg-darkgray border border-border/30 dark:border-darkborder/30 min-w-0 overflow-hidden ${isCardShadow ? 'shadow-md dark:shadow-dark-md' : 'shadow-none'
          }`,
          className,
        )}
        {...props}
