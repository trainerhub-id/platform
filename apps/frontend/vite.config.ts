        ...
        rollupOptions: {
            output: {
                manualChunks(id) {
                    ...
                    if (id.includes('media-tracks') || id.includes('castable-video') || id.includes('custom-media-element')) {
                    ...
                    if (id.includes('node_modules/.pnpm/@tanstack+react-query') || id.includes('@tanstack/react-query')) {
                        return 'react-query';
                    }
                },
            },
